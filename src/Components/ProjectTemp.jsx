...
const ProjectTemp = () => {
  ...
  return (
    <>
      <div className="project-card-main flex justify-center items-center gap-5">
        <div className="project-temp  flex justify-start lg:flex-row  flex-col lg:gap-20 gap-10 lg:mx-[6rem]  ">
          <div className="lg:w-[36rem]   lg:relative  w-[95%] my-3   lg:mx-3 mx-4 ">
            <div className="lg:h-[100vh] w-full   mx-auto   flex justify-center items-center flex-col   ">
              <motion.div
                initial="hidden"
                whileInView="visible"
                viewport={{ once: false }}
                variants={fadeUpAnimation}
                className="lg:w-[22rem]  md:w-[22rem] lg:mx-0 md:mx-auto w-[98%] mx-2  rounded-xl bg-[#2B2C2D]/50  lg:py-5 py-3 lg:h-[38rem] h-[35rem] flex flex-col justify-start lg:p-5 "
              >
